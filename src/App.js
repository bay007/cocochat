...
class App extends Component {
  ...
  componentWillMount() {
    ...
    let colorHeader = document
      .getElementById('coconnut-chat-widget')
      .getAttribute('color-header');
    if (colorHeader) {
      this.setState({ colorHeader: colorHeader });
    }
    let colorBody = document
      .getElementById('coconnut-chat-widget')
      .getAttribute('color-body');
    if (colorBody) {
    ...
    if (this.state.isWidgetStandBy)
      ...
      return (
        <div style={this.chatWidth()}>
          <CoconuttChat>
            <div
              className="coconutt-chat-menu"
              style={{ backgroundColor: this.state.colorHeader }}
            >
              <div className="coconutt-chat-back">
                <img
                  ...
                  onClick={() => {
                    this.setState({
                      isWidgetStandBy: !this.state.isWidgetStandBy
                    });
                  }}
                />
              </div>
            ...
            <div
              className="coconutt-chat-chat"
              style={{
                backgroundColor: this.state.colorBody,
                maxHeight: this.state.windowSize.height * 0.7,
                minHeight: this.state.windowSize.height * 0.45
              }}
            >
              <ol>
            ...
            <div className="coconutt-chat-textarea">
              <textarea
                ...
                rows="2"
                readOnly={
                  ChatStore.isErrorExistsOnPNLProcessMessage ? true : false
                }
